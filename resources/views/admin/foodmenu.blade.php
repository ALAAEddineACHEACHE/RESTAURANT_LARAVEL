        ...
        <div class="content-wrapper">
            <div class="row" style="margin-left:100px; width:160%;">
                <div class="col-lg-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 style="color: red;" class="card-title">FoodMenu Table</h4>
                                        ...
                                        <tr>
                                            @foreach ($data as $data)
                                                ...
                                                <td style="height: 100px;width:100px;"><img
                                                        src="foodimage/{{ $data->image }}" alt="imagenotrecognized"
                                                        style="height: 100px;width:100px;">
                                                </td>
                                                <td style="color: black">{{ $data->price }} dh</td>
                                                <td style="color: black">
                                                    <label>{{ $data->description }}</label>
                                                </td>
                                                <td><a style="color: red;" href="{{ url('deletemenu', $data->id) }}">
