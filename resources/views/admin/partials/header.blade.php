        ...
        <div class="navbar-menu-wrapper d-flex align-items-top">
            <ul class="navbar-nav">
                <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                    <h1 class="welcome-text">Good Morning, <span class="text-black fw-bold">Admin Alae</span></h1>
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                    <a class="nav-link" id="UserDropdown" href="" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <img class="img-xs rounded-circle" width="100px" height="100px"
                            src="{{ asset('assetadmin/images/faces/alae.jpg') }}" alt="Profile image">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                        <div class="dropdown-header text-center">
                            <img class="img-md rounded-circle" height="100px" width="100px"
                                src="{{ asset('assetadmin/images/faces/alae.jpg') }}" alt="Profile image">
                            <p class="mb-1 mt-3 font-weight-semibold">Alae Eddine Acheache</p>
                            <p class="fw-light text-muted mb-0">admin@gmail.com</p>
                        </div>
                        <a href="{{ url('') }}" class="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg"
                                width="16" height="16" fill="currentColor" class="bi bi-house-door-fill"
                                viewBox="0 0 16 16">
                                <path
                                    d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5z" />
                            </svg><i class="bi bi-house-door-fill text-primary me-2"></i>
                            HomePage</a>
                        <a href="{{ url('redirects') }}" class="dropdown-item"><i
                                class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i> My
                            Profile <span class="badge badge-pill badge-danger">1</span></a>
                        <a href="{{ url('orders') }}" class="dropdown-item"><i
                                class="dropdown-item-icon mdi mdi-message-text-outline text-primary me-2"></i>
                            Messages(Orders)<span class="badge badge-pill badge-danger">1</span></a>
                        <a href="{{ url('viewreservation') }}" class="dropdown-item"><i
                                class="dropdown-item-icon mdi mdi-calendar-check-outline text-primary me-2"></i>
                            Messages(Reservations)<span class="badge badge-pill badge-danger">1</span> </a>
                        <a href="{{ url('generalsettings') }}" class="dropdown-item"><i
