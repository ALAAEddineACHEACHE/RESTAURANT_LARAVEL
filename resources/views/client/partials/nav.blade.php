<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="user-profile">
        <div class="user-image">
            <img src="{{ asset('client/assets/images/client.jpg') }}">
        </div>
        <div class="user-name">
            Hello {{ $user_name }} !
        </div>
    ...
    <ul class="nav">
        <li class="nav-item">
            <a class="nav-link" href="{{ url('') }}">
                ...
                <span class="menu-title">Return to Home Page</span>
            </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ url('clientreservation') }}">
        ...
        {{-- <li class="nav-item">
            <a class="nav-link" href="{{ asset('client/pages/tables/basic-table.html') }}">
                <i class="icon-command menu-icon"></i>
                <span class="menu-title">Tables</span>
            </a>
        </li> --}}
        <li class="nav-item">
            <a class="nav-link" href="{{ url('clientorders') }}">
                <i class="icon-pie-graph menu-icon"></i>
